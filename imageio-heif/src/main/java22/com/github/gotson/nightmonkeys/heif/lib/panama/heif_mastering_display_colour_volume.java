...
public class heif_mastering_display_colour_volume {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(3, heif_h.C_SHORT).withName("display_primaries_x"),
        MemoryLayout.sequenceLayout(3, heif_h.C_SHORT).withName("display_primaries_y"),
        heif_h.C_SHORT.withName("white_point_x"),
        heif_h.C_SHORT.withName("white_point_y"),
        heif_h.C_INT.withName("max_display_mastering_luminance"),
        heif_h.C_INT.withName("min_display_mastering_luminance")
     ...
     * }
     */
    public static short display_primaries_x(MemorySegment struct, long index0) {
        return (short)display_primaries_x$ELEM_HANDLE.get(struct, 0L, index0);
    }
     ...
     * }
     */
    public static void display_primaries_x(MemorySegment struct, long index0, short fieldValue) {
    ...
    private static final long display_primaries_y$OFFSET = 6;
     ...
     * }
     */
    public static short display_primaries_y(MemorySegment struct, long index0) {
        return (short)display_primaries_y$ELEM_HANDLE.get(struct, 0L, index0);
    }
     ...
     * }
     */
    public static void display_primaries_y(MemorySegment struct, long index0, short fieldValue) {
        display_primaries_y$ELEM_HANDLE.set(struct, 0L, index0, fieldValue);
    }

    private static final OfShort white_point_x$LAYOUT = (OfShort)$LAYOUT.select(groupElement("white_point_x"));
     ...
     * }
     */
    public static final OfShort white_point_x$layout() {
        return white_point_x$LAYOUT;
    }

    private static final long white_point_x$OFFSET = 12;
     ...
     * }
     */
    public static short white_point_x(MemorySegment struct) {
     ...
     * }
     */
    public static void white_point_x(MemorySegment struct, short fieldValue) {
        struct.set(white_point_x$LAYOUT, white_point_x$OFFSET, fieldValue);
    }

    private static final OfShort white_point_y$LAYOUT = (OfShort)$LAYOUT.select(groupElement("white_point_y"));
     ...
     * }
     */
    public static final OfShort white_point_y$layout() {
        return white_point_y$LAYOUT;
    }

    private static final long white_point_y$OFFSET = 14;
     ...
     * }
     */
    public static short white_point_y(MemorySegment struct) {
     ...
     * }
     */
    public static void white_point_y(MemorySegment struct, short fieldValue) {
    ...
    private static final long max_display_mastering_luminance$OFFSET = 16;
    ...
    private static final long min_display_mastering_luminance$OFFSET = 20;

...
public class __darwin_pthread_handler_rec {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        heif_h.C_POINTER.withName("__routine"),
        heif_h.C_POINTER.withName("__arg"),
        heif_h.C_POINTER.withName("__next")
    ...
    public static class __routine {
        ...
        private static final MethodHandle UP$MH = heif_h.upcallHandle(__routine.Function.class, "apply", $DESC);

...
public class __darwin_pthread_handler_rec {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        demux_h.C_POINTER.withName("__routine"),
        demux_h.C_POINTER.withName("__arg"),
        demux_h.C_POINTER.withName("__next")
    ...
    public static class __routine {
        ...
        private static final MethodHandle UP$MH = demux_h.upcallHandle(__routine.Function.class, "apply", $DESC);

...
public class __darwin_pthread_handler_rec {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        decode_h.C_POINTER.withName("__routine"),
        decode_h.C_POINTER.withName("__arg"),
        decode_h.C_POINTER.withName("__next")
    ...
    public static class __routine {
        ...
        private static final MethodHandle UP$MH = decode_h.upcallHandle(__routine.Function.class, "apply", $DESC);
